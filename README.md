...
### LiveSplit Setup
  ...
  3. Import the splits (for example from the downloaded file `MC_Splits.lss`). If you do not want to use my splits you can still import the `MC.lss` file and delete the segement timers, or write in the boss names yourself and start blank. 
